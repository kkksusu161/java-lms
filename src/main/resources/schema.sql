...
create table session_order (
    ...
    sale_price bigint not null,
    ord_stat_code bigint not null comment '최종 상태 대기 10 승인 20 취소 30',
    appr_id bigint comment '승인한 강사id',
...
ALTER TABLE session_order
    alter column ord_stat_code bigint not null COMMENT ;
*/
/*
ALTER TABLE session_order
    alter column appr_id bigint not null COMMENT 'instructor 테이블의 강사id';
*/
create table instructor (
    instructorId bigint generated by default as identity,
